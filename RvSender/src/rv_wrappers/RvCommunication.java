 ...
 */
public class RvCommunication implements TibrvMsgCallback {
...
//                rvdTransport.(((RVMessageInterfaceWraper) responseMsg).getMessage(), ((RVMessageInterfaceWraper) sourceMsg).getMessage());
//            }
//        } catch (TibrvException e) {
